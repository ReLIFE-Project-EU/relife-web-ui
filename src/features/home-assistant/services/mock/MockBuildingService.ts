...
import type { BuildingOptions, IBuildingService, SelectOption } from "../types";
...
export const EPC_CLASSES: string[] = ["A+", "A", "B", "C", "D", "E", "F", "G"];
...
const COUNTRY_DEFAULTS: Record<string, Partial<BuildingInfo>> = {
  AT: {
    climateZone: "D",
