...
import { MeasureEffectSummary } from "./MeasureEffectSummary";

interface RenovationMeasureCardProps {
...
export function RenovationMeasureCard({
  measure,
  isSelected,
  onToggle,
  disabled,
  tooltipLabel = measure.description,
  tooltipWidth = 260,
}: RenovationMeasureCardProps) {
